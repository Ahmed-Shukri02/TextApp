...
export default class Backgrounds{ // returns all backgrounds as base 64 encoded url links
  ...
  static CircleBackground(){
    return this.urlEncode(
      '<svg id="visual" viewBox="0 0 960 540" width="960" height="540" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"><rect x="0" y="0" width="960" height="540" fill="#fff"></rect><g fill="#1B74E4" stroke="#1B74E4" stroke-width="2"><circle r="85" cx="766" cy="161"></circle><circle r="26" cx="379" cy="261"></circle><circle r="69" cx="558" cy="372"></circle><circle r="59" cx="147" cy="404"></circle><circle r="26" cx="568" cy="103"></circle><circle r="56" cx="769" cy="390"></circle></g></svg>'
    )
  }
